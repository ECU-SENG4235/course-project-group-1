...
video_mode_button.place(x=194.0, y=219.0, width=100.0, height=20.0)
...
audio_mode_button.place(x=435.5, y=219.0, width=100.0, height=20.0)
...
video_format_menu.place(x=305.5, y=279.0, width=130.0, height=30.0)
video_format_label = ttk.Label(window, text="Select Video Format")
video_format_label.place(x=305.5, y=254.0)

audio_format_menu = ttk.OptionMenu(window, audio_format_var, 'mp3', 'mp3', 'mp4', 'wav', 'ogg')
audio_format_menu.place(x=544.0, y=281.0, width=130.0, height=30.0)
audio_format_label = ttk.Label(window, text="Select Audio Format")
audio_format_label.place(x=544.0, y=254.0)

# Radio buttons for Audio Quality
high_quality_button = Radiobutton(window, text="High", variable=quality_var, value='High')
high_quality_button.place(x=550.0, y=317.5, width=50.0, height=20.0)
low_quality_button = Radiobutton(window, text="Low", variable=quality_var, value='Low')
low_quality_button.place(x=550.0, y=343.0, width=50.0, height=20.0)
quality_label = ttk.Label(window, text="Select Audio Quality")
quality_label.place(x=420.0, y=330.0)
