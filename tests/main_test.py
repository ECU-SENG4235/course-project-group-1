...
class TestDownload(unittest.TestCase):
    ...
    def test_download_video(self):
        ...
        self.assertTrue(os.path.exists(f"{video_id}.mp4"))
        self.assertTrue(os.path.getsize(f"{video_id}.mp4") > 0)
...
'''    def test_download_audio_high_quality(self):
        ...
        self.assertTrue(os.path.exists(f"{audio_id}.webm"))
        self.assertTrue(os.path.getsize(f"{audio_id}.webm") > 0)
...
if __name__ == '__main__':
    ...
    '''Still need to download actual audio'''
