...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\kenda\Projects\ProjManagementTestBench\course-project-group-1\guiPage2\build\assets\frame0")
...
def open_guiPage2():
    ...
    photo_images.append(image_image_1)  # Keep a reference
    button_image_1 = PhotoImage(file=relative_to_assets("button_1.png"))
    photo_images.append(button_image_1)  # Keep a reference
    button_image_2 = PhotoImage(file=relative_to_assets("button_2.png"))
    photo_images.append(button_image_2)
    button_image_3 = PhotoImage(file=relative_to_assets("button_3.png"))
    photo_images.append(button_image_3)
    button_image_4 = PhotoImage(file=relative_to_assets("button_4.png"))
    photo_images.append(button_image_4)
    button_image_5 = PhotoImage(file=relative_to_assets("button_5.png"))
    photo_images.append(button_image_5)
    button_image_6 = PhotoImage(file=relative_to_assets("button_6.png"))
    photo_images.append(button_image_6)
    button_image_7 = PhotoImage(file=relative_to_assets("button_7.png"))
    photo_images.append(button_image_7)
    button_image_8 = PhotoImage(file=relative_to_assets("button_8.png"))
    photo_images.append(button_image_8)
    button_image_9 = PhotoImage(file=relative_to_assets("button_9.png"))
    photo_images.append(button_image_9)
    button_image_10 = PhotoImage(file=relative_to_assets("button_10.png"))
    photo_images.append(button_image_10)
    button_image_11 = PhotoImage(file=relative_to_assets("button_11.png"))
    photo_images.append(button_image_11)
    button_image_12 = PhotoImage(file=relative_to_assets("button_12.png"))
    photo_images.append(button_image_12)
    button_image_13 = PhotoImage(file=relative_to_assets("button_13.png"))
    photo_images.append(button_image_13)

    image_1 = canvas.create_image(
        554.0,
        253.0,
        image=image_image_1  # Use the existing PhotoImage object directly
)
